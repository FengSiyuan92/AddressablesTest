...
namespace UnityEditor.AddressableAssets.Build.DataBuilders
{
    ...
    [CreateAssetMenu(fileName = "BuildApkPackedMode.asset", menuName = "Addressables/Content Builders/APKBuilder")]
    public class BuildAPKPackedMode : BuildScriptBase
    {
        /// <inheritdoc />
        ...
        {
            return typeof(T).IsAssignableFrom(typeof(AddressablesAPKBuildResult));
        }
        ...
        protected override string ProcessGroup(AddressableAssetGroup assetGroup, AddressableAssetsBuildContext aaContext)
        {
            ...
            if (assetGroup.PackageName != aaContext.Settings.CurrentBuildPackage)
            {
                return string.Empty;
            }
